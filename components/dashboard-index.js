            ...
            <>
                ...
                <div className="relative flex items-center justify-between h-16">
                  ...
                  <div className="hidden lg:block lg:w-80">
                    <div className="flex items-center justify-end">
                      <div className="flex">
                        <a
                          href={'https://wa.me/+56983841944?text=¡Hola! Necesito ayuda con mi cuenta. Mi correo es ' + session.user.email}
              ...
              <Disclosure.Panel className="lg:hidden">
                <div className="px-2 pt-2 pb-3">
                  ...
                  <Disclosure.Button
                    as="a"
                    href={'https://wa.me/+56983841944?text=¡Hola! Necesito ayuda con mi cuenta.'}
