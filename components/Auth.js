...
export default function Auth() {
  ...
  const handleSignUp = async () => {
    try {
      ...
      // aca mandar un mensaje bonito
      alert('Checkea tu mail para confirmar el registro')
    } catch (error) {
      // aca mandar un error bonito
      ...
      <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img
            ...
            alt="Workflow"
          />
          {isSignUp ? <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900"> Registrate Aqui</h2> :
