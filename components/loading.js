export default function Loading() {
  ...
  return (
    <>
      <div className="w-[100vw] h-[100vh] py-10 px-10 bg-indigo-500 flex flex-wrap flex-col justify-around items-center" aria-hidden="true">
        <svg className="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
          <g className="car">
          ...
          <circle className="wheel-details" cx="18." cy="56" r="3.12"/>
          <circle cx="18" cy="56" r="1.85"/>
          <path className="wheel-details" d="M18.05,51.11a4.39,4.39,0,0,1,2,.26l.47.21.45.25.41.31.39.34a4.92,4.92,0,0,1,1.1,1.71,4.42,4.42,0,0,1,.27,2,.15.15,0,0,1-.16.13.16.16,0,0,1-.13-.13h0a5.73,5.73,0,0,0-.49-1.79,5.05,5.05,0,0,0-1-1.48,5.33,5.33,0,0,0-1.49-1,5.86,5.86,0,0,0-1.78-.48h0a.15.15,0,0,1-.13-.16A.14.14,0,0,1,18.05,51.11Z"/>
          </g>

          <g className="wheel front-wheel">
          <circle cx="59" cy="56" r="6.75"/>
          <circle className="wheel-details" cx="59" cy="56" r="3.12"/>
          <circle cx="59" cy="56" r="1.85"/>
          <path className="wheel-details" d="M59.27,51.11a4.39,4.39,0,0,1,2,.26l.47.21.44.25.42.31.38.34a5,5,0,0,1,1.11,1.71,4.56,4.56,0,0,1,.26,2,.14.14,0,0,1-.16.13.16.16,0,0,1-.13-.13h0a5.71,5.71,0,0,0-.48-1.79,5.28,5.28,0,0,0-1-1.48,5.14,5.14,0,0,0-1.48-1,6,6,0,0,0-1.78-.48h0a.14.14,0,0,1-.12-.16A.13.13,0,0,1,59.27,51.11Z"/>
          </g>

          <line className="line line-1"  x1="77" y1="37" x2="4" y2="37"/>
          <line className="line line-2" x1="77" y1="49" x2="4" y2="49"/>
          <line className="line line-floor" x1="76.5" y1="62.43" x2="3.5" y2="62.43"/>
          <path className="cloud" d="M71,26.15a3.37,3.37,0,0,0-3.29-2.65,2.11,2.11,0,0,0-.36,0,5,5,0,0,0-9.73,1.32,3.75,3.75,0,0,0-.82-.09,3.83,3.83,0,0,0-.08,7.65H70.87A3.13,3.13,0,0,0,71,26.15Z"/>
        </svg>
      </div>
    </>
