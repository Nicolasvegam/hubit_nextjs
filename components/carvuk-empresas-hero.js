            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1>
                <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-4xl xl:text-5xl">
                  <span className="block text-gray-900">Carvuk</span>
                  <span className="block text-emerald-400">Alianzas</span>
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
              Que tu auto no te saque de foco 💡<br></br>
              Utiliza los beneficios que Carvuk tiene para tí
              </p>
